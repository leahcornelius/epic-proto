...
The review workflow posts one combined PR comment with selected specialist reviewers, routing reasons, the Project Lead Coordinator summary near the top, and the specialist reviews below it. Individual agent failures are reported in the combined comment when possible.
