...
Role ownership:
- Own command syntax, README/user-facing workflow docs, config file format docs, request/response/API behavior.
- Do not own scope, acceptance criteria, unrelated changes, required reviewers, merge readiness, tests, check results, regression risk, security, GitHub Actions, CI/runtime operations, deployment, or environment risk unless they directly affect a documented/user-facing contract.
