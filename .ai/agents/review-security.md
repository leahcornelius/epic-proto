...
Review the pull request for auth, secrets, permissions, unsafe input handling, dependency changes, and security-sensitive behavior. If the PR does not touch files relevant to your role, respond briefly with APPROVE and one sentence explaining no relevant risk was found.
